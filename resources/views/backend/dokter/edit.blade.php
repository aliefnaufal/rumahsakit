        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">Dokter Edit</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <form action="{{Route('dokter.update')}}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="email" class="col-md-4 control-label">Spesialis</label>

                            <div class="col-md-12">
                                <select name="spesialis_id" id="spesialis_id" class="form-control">
                                    @foreach($spesialis as $s)
                                        <option value="{{$s->id}}" <?php if($s->id == $data->spesialis_id){ ?> selected="selected" <?php } ?>>{{$s->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
